...
"""Zentis object detection dataset module."""
    ...
    def __getitem__(self, index: int) -> Tuple[torch.tensor, Dict[Any, Any]]:
        ...
        with open(self.label_path + os.sep + id + '.json') as file:
            ...
            with ThreadPoolExecutor() as pool:
                path = map(lambda img: img_path + img['name'], data)
...
class Zentis(Dataset):
    def __init__(self,
        ...
        self.datasets = [_Zentis(root=root, dataset=dataset, train=train,
